...
def JO(uid):
    ...
    btnProfile = Button(frame2, text="My Profile", font=('arial', 14, 'bold'), bg='cyan', fg='black', bd=12, padx=75,
                        pady=10, width=20,
                        command=lambda: job_profile.job_prof(uid)).grid(row=0, column=0)
    btnLC = Button(frame2, text="List of Jobs", font=('arial', 14, 'bold'), bg='light pink', fg='black', bd=12, padx=75,
                   pady=10, width=20,
